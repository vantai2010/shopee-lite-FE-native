...
const Voucher = () => {
    ...
    const [listVouchers, setListVouchers] = useState([
        { id: 1, productId: 58, userId: "9", type: keyMap.VANCHUYEN, discount: "300000đ", condtionsPrice: "60000000", timeEnd: "25/10/2023" },
        { id: 2, productId: 58, userId: "9", type: keyMap.GIAMGIA, discount: "200000đ", conditionsPrice: "100000", timeEnd: "25/10/2023" },
        { id: 3, productId: 58, userId: "9", type: keyMap.VANCHUYEN, discount: "10000đ", conditionsPrice: "100000", timeEnd: "25/10/2023" },
        { id: 4, productId: 58, userId: "9", type: keyMap.GIAMGIA, discount: "10%", conditionsPrice: "100000", timeEnd: "25/10/2023" },
        { id: 5, productId: 58, userId: "9", type: keyMap.VOUCHERSHOP, discount: "500000đ", conditionsPrice: "100000", timeEnd: "25/10/2023" },
    ])
        ...
        <>
            <ScrollView>
                            ...
                            listVouchers.map(item => {
                                if (item.type === keyMap.VANCHUYEN) {
                                    return (
                                        <TouchableOpacity
                                            key={item.id}
                                            onPress={() => dataSend.productFee > item.conditionsPrice ? handleAddColorVanChuyenVoucher(item) : null}
                                            style={styles.voucher}
                                        >
                                            <View style={{ flexDirection: "row" }}>
                                                <View>
                                                    <Image style={{ width: 100, height: 100 }} source={bg21} />
                                                </View>
                                                <View style={{ marginLeft: 10 }}>
                                                    <Text style={{ fontWeight: "500" }}>Giảm tối đa {item.discount}</Text>
                                                    <Text style={{ fontSize: 12 }}>Đơn tối thiểu {handleFormatMoney(item.conditionsPrice)}</Text>
                                                    <Text style={{ fontSize: 12, color: "#9c9595" }}>
                                                        Hết hạn {item.timeEnd}
                                                    </Text>
                                                </View>
                                            </View>
                                            <View
                                                style={[
                                                    ...
                                                    {
                                                        backgroundColor:
                                                            isVoucherShipPressed === item.id ? "#ee4d2d" : "#ffffff",
                                                    },
                                                ]}
                                            ></View>
                                        </TouchableOpacity>
                ...
                <View style={styles.containerCenter}>
                    <Text style={{ fontSize: 16, fontWeight: "600" }}>Mã giảm giá</Text>
                    <Text style={{ fontSize: 13, color: "#9c9595" }}>
                        Có thể chọn 1 loại voucher
                    </Text>
                    {/* <TouchableOpacity
                            ...
                            listVouchers.map(item => {
                                if (item.type === keyMap.GIAMGIA) {
                                    return (
                                        <TouchableOpacity
                                            key={item.id}
                                            onPress={() => dataSend.productFee > item.conditionsPrice ? handleAddColor(item) : null}
                                            style={styles.voucher}
                                        >
                                            <View style={{ flexDirection: "row" }}>
                                                <View>
                                            ...
                                            <View
                                                style={[
                                                    ...
                                                    {
                                                        backgroundColor:
                                                            isVoucherPressed === item.id ? "#ee4d2d" : "#ffffff",
                                                    },
                                                ]}
                                            ></View>
                                        </TouchableOpacity>
                                ...
                                if (item.type === keyMap.VOUCHERSHOP) {
                                    return (
                                        ...
                                        >
                                            <View style={{ flexDirection: "row" }}>
                                                <View>
                                                    <Image style={{ width: 100, height: 100 }} source={bg25} />
                                                </View>
                                                <View style={{ marginLeft: 10 }}>
                                                    <Text style={{ fontWeight: "500" }}>Giảm {item.discount}</Text>
                                                    <Text style={{ fontSize: 12 }}>Đơn tối thiểu {handleFormatMoney(item.conditionsPrice)}</Text>
                                                    <Text style={{ fontSize: 12, color: "#9c9595" }}>
                                                        Hết hạn {item.timeEnd}
                                                    </Text>

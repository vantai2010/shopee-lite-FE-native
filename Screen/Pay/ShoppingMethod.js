...
export default function ShoppingMethod() {
    ...
    useEffect(() => {
        const cal = async () => {
            let distance = await calDistanceAddress(dataNaviagteSend.addressUser, dataNaviagteSend.addressShop)
            return distance
        }
            ...
            <View style={styles.container}>
                ...
                <View style={styles.Description}>
                    <View style={styles.boxMethod}>
                        <View style={styles.Method}>
                            <Text style={{ fontSize: 12, color: "grey" }}>
                                Các phương thức vận chuyển Shoppee
                            </Text>
                        </View>
                    ...
                    <View style={styles.ContentMethod}>
                        <Text style={{ fontSize: 12 }}>
                            Bạn có thể theo dõi đơn hàng trên ứng dụng Shopee khi chọn một
                ...
                <View style={styles.Content}>
                    ...
                    <TouchableOpacity
                        ...
                        onPress={() => shipFastMethod.cost === 0 ? null : handleCheck(shipFastMethod)}
                    >
                        <View style={styles.Fast}>
                            ...
                            <View style={styles.dateReceive}>
                                ...
                                >
                                    Nhận hàng vào ngày {shipFastMethod.date}
                                </Text>
                            </View>
                        </View>
                        <View
                    ...
                    <TouchableOpacity
                        ...
                        onPress={() => shipFlashMethod.cost === 0 ? null : handleCheck(shipFlashMethod)}
                    >
                        <View style={styles.Fast}>
                            <View style={styles.FastCost}>
                                <Text
                            ...
                            <View style={styles.dateReceive}>
                                ...
                                >
                                    Nhận hàng vào ngày {shipFlashMethod.date}
                                </Text>
                            </View>
                        </View>
                        <View

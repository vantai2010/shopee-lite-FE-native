    ...
    <ScrollView>
      <View style={styles.container}>
        <View style={styles.InformationTransport}>
          ...
          <View style={{ flex: 2 }}>
            <Text style={{ fontSize: 'h2', fontWeight: "600" , marginBottom:10}}>
        ...
        <View style={{backgroundColor:'#fff', marginTop:10}}>
            <View style={{padding:12, borderBottomWidth:1, borderBottomColor:'rgba(0,0,0,.05)', flexDirection:'row', justifyContent:'space-between'}}>
                <Text>Devan Silver</Text>
                <View style={{flexDirection:'row', justifyContent:'flex-end'}}>
                    <Text style={{fontWeight:300}}>Xem Shop</Text>
                    <MaterialIcons name="keyboard-arrow-right" size={24} style={{ color: 'rgba(0, 0, 0, .4)', lineHeight:20 }} />
                </View>
            </View>
            <View style={{flexDirection:'row', justifyContent:'space-between', margin:12}}>
                <Image source={require('../../../Image/background13.png')} style={{resizeMode:'contain', height:80, width:80}}/>
            ...
            <View style={{ margin:12}}>
                ...
                <View style={{flexDirection:'row', justifyContent:'space-between',marginBottom:10}}>
                    <Text style={{color:'rgba(0,0,0,.4)'}}>Giảm giá phí vận chuyển</Text>
                    <Text style={{color:'rgba(0,0,0,.4)'}}>-đ16.500</Text>
                </View>
                <View style={{flexDirection:'row', justifyContent:'space-between',marginBottom:10}}>
        ...
        <View style={{backgroundColor:'#fff', marginTop:12}}>
            <View style={{margin:12}}>
                <View style={{flexDirection:'row', justifyContent:'flex-start'}}>
                    <Ionicons name="md-wallet" size={24} color="#ee4d2d" style={{lineHeight:30}}/>
                    <Text style={{lineHeight:30, marginLeft:10, fontSize:16, fontWeight:600}}>Phương thức thanh toán</Text>
                </View>
                <Text style={{color:'rgba(0,0,0,.4)', marginTop:8, marginLeft:35}}>Ví ShopeePay</Text>
            </View>
        </View>

        <View style={{ backgroundColor:'#fff', marginTop:12, borderBottomWidth:1, borderBottomColor:'rgba(0,0,0,.05)',}}>
            <View style={{margin:12}}>
                <View style={{flexDirection:'row', justifyContent:'space-between',marginBottom:10}}>
                ...
                <View style={{flexDirection:'row', justifyContent:'space-between',marginBottom:10}}>
                    <Text style={{color:'rgba(0,0,0,.4)'}}>Thời gian thanh toán</Text>
                    <Text style={{color:'rgba(0,0,0,.4)'}}>18-09-2023 00:46</Text>
                </View>
                <View style={{flexDirection:'row', justifyContent:'space-between',marginBottom:10}}>
                    <Text style={{color:'rgba(0,0,0,.4)'}}>Thời gian giao hàng cho vận chuyển</Text>
                    <Text style={{color:'rgba(0,0,0,.4)'}}>18-09-2033 17:46</Text>
                </View>
                <View style={{flexDirection:'row', justifyContent:'space-between',marginBottom:10}}>
                    <Text style={{color:'rgba(0,0,0,.4)'}}>Thời gian hoàn thành</Text>
        ...
        <View style={{backgroundColor:'#fff',}}>
            <View style={{flexDirection:'row', justifyContent:'space-between', margin:12}}>
                <TouchableOpacity style={{borderWidth:1, paddingHorizontal:32, paddingVertical:12}}>

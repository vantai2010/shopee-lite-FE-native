...
import { ScrollView, Dimensions ,StyleSheet, Text, View, TextInput, SafeAreaView, TouchableOpacity, Button } from 'react-native';
...
const choose = [
    ...
    },
    {
        ...
        star: <FontAwesome name="star" size={10} color="#ffad27" style={{padding: 5}}/>,
        quantity: '(Tất cả)'
    },
    {
        id: 3,
...
const item = [
    {
        id: 0,
        name: 'Đạt',
        avatar: 'https://cdn.oneesports.vn/cdn-data/sites/4/2022/03/fo4-beckham-team-color.jpg',
        star: 5,
        type: 'Đen, L',
        content: 'FIFA Online 4 là một trò chơi bóng đá trực tuyến nhiều người chơi miễn phí được phát triển bởi EA Spearhead và được phát hành bởi Nexon. Trò chơi được thông báo lần đầu vào tháng 11 năm 2017, và ra mắt lần đầu tiên vào ngày 17 tháng 5 năm 2018 ở Hàn Quốc',
...
const renderStar = (item) => {
    if(item === 1){
        return( <View>
        <FontAwesome name="star" size={13} color="#ffad27" style={{paddingHorizontal: 2}} />
        </View>
        )
    }
    else if(item > 0 && item <1 ){
        return(
            <FontAwesome name="star-half-empty" size={13} color="#ffad27"  />
        )
    }
    else{
        return(
  ...
  return (
    ...
    <SafeAreaView style={{flex:1}}>
        <ScrollView style={styles.wrapper}>
                    ...
                    <TouchableOpacity style={styles.iconheader} onPress={() => handleNavigate(namePage.EVALUATE)} >
                                ...
                                <TouchableOpacity style={styles.titleContent}> 
                                    <View style={styles.headerContent}> 
                                        <View style={styles.Avatar}>
                                            <Avata 
                                                avatarUrl={'https://cdn.oneesports.vn/cdn-data/sites/4/2022/03/fo4-beckham-team-color.jpg'}
